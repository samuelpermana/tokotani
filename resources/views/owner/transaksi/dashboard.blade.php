...
<div class="container">
    ...
    <div class="mb-4">
        <!-- Buttons to create 'beli' and 'jual' transactions -->
        <a href="{{ route('owner.transaksi.create-beli') }}" class="btn btn-success">Tambah Transaksi Beli</a>
        <a href="{{ route('owner.transaksi.create-jual') }}" class="btn btn-primary">Tambah Transaksi Jual</a>
    </div>
