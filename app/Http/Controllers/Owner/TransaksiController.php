...
class TransaksiController extends Controller
{
    public function dashboard()
    {
        ...
        return view('owner.transaksi.dashboard', compact('transaksis', 'totalTransaksi'));
    }
    public function masuk()
    {
        ...
        return view('owner.transaksi.masuk', compact('transaksis', 'totalTransaksi'));
    }
    ...
    public function keluar()
    {
        ...
        return view('owner.transaksi.keluar', compact('transaksis', 'totalTransaksi'));
    }
    ...
    {
        $barangs = Barang::all();
        return view('owner.transaksi.create-beli', compact('barangs'));
    }
    ...
    {
        $barangs = Barang::all();
        return view('owner.transaksi.create-jual', compact('barangs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('owner.transaksi.dashboard')->with('success', 'Transaksi berhasil dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.transaksi.edit', compact('transaksi', 'barangs'));
    }
    ...
    public function destroy($id)
    {
        $transaksi = Transaksi::findOrFail($id);
        $transaksi->delete();
        return redirect()->route('owner.transaksi.dashboard')->with('success', 'Transaksi berhasil dihapus.');
    }
    ...
    public function print($id)
    {
        ...
        return view('owner.transaksi.print', compact('transaksi'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('owner.transaksi.dashboard')->with('success', 'Transaksi berhasil diperbarui.');
    }
